...
```bash
git clone https://github.com/TU_USUARIO/go-course.git
cd go-course
```
...
2. Ponle un nombre a tu repositorio (ejemplo: `go-course`)
...
> Si el nombre del repo es el mismo (`go-course`), no necesitas cambiar nada.
